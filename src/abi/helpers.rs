...
///
/// ```rust,ignore
/// use macroforge_ts_syn::{insert_into_class, ClassIR, SpanIR};
///
/// fn add_method(class: &ClassIR) -> Patch {
///     insert_into_class(class.body_span, "toString() { return 'MyClass'; }")
/// }
///
/// // Given a class like:
/// // class Foo {
...
///
/// ```rust,ignore
/// let patch = insert_into_class(class.body_span, code)
...
///
/// ```rust,ignore
/// use macroforge_ts_syn::{insert_class_member, ident};
